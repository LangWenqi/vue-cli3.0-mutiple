<template>
    <div ref="wrapper" class="list-wrapper">
        <div class="scroll-content" :class="{'horizontal':direction==='horizontal'}">
            <slot>
                <ul ref="list" class="list-content">
                    <li @click="clickItem($event,item)" class="list-item" v-for="(item,index) in data" v-text="index"></li>
                </ul>
            </slot>
        ...
        <slot name="pulldown" :pullDownRefresh="pullDownRefresh" :pullDownStyle="pullDownStyle" :beforePullDown="beforePullDown" :pulling="pulling" :bubbleY="bubbleY">
            <div ref="pulldown" class="pulldown-wrapper" :style="pullDownStyle" v-show="refreshing" v-if="pullDownRefresh">
                ...
                <div class="after-trigger" v-else>
                    ...
                    <div v-else><span v-text="refreshTxt"></span></div>
                </div>
            </div>
        </slot>
    </div>
